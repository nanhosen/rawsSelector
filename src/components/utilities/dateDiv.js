...
app.DateSlider = function(settings) {
...
inherits(app.DateSlider, Control)

app.DateSlider.prototype.setMap = function(map) {
  var i, child;
...
app.DateSlider.prototype.open = function(id) {
  var i, child;
...
app.DateSlider.prototype.close = function() {
...
app.DateSlider.prototype._onClick = function(evt) {
  evt.preventDefault()
...
app.DateSlider.prototype._onCloseClick = function() {
  this.close()
}
